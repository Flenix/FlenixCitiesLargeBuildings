...
import co.uk.silvania.cities.largebuildings.client.EscalatorModel;
...
public class TileEntityEscalatorRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
		...
		Minecraft.getMinecraft().renderEngine.func_110577_a(new ResourceLocation("fc_largebuildings", "textures/entities/escalator.png"));
		GL11.glPushMatrix();
